...
int APOx = A2;  //sensor de presión de oxígeno
int APAir = A3;  //sensor de presión de aire BIEN confirmado
//int AFOx = A2; //sensor de flujo de oxígeno
int AFAir = A5; //sensor de flujo de aire
int AOs = A4;    //sensor de oxígeno bien confirmado
int APexh = A1; //sensor de presión exhalatoria bien confirmado
